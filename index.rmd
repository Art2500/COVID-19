...
```
 <!-- This chunk was for writing the output of the underlying conditions graph. The code takes the dataset and filters the conditions. It then produces an ANOVA analysis on the information --> 
...
```
 <!-- This chunk makes a bar graph of the adult hospitalizations. it filters out no known condition --> 
