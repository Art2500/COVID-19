...
ggplot(deaths_underlying, aes(reorder(Condition, -`Number of COVID-19 Deaths`))) + geom_bar(aes(weight = `Number of COVID-19 Deaths`)) + theme(axis.text.x = element_text(angle = 75, vjust = 1, hjust = 1))+labs(y="Deaths", x="Conditions")+ggsave("./figures/Underlying_conditions.png")
