...
```{r}
provisional_death_counts<-read_csv("./raw_data/Provisional_Death_Counts.csv") %>% select(State,Indicator,`Start week`,`All COVID-19 Deaths (U07.1)`,`Deaths with Pneumonia and COVID-19 (J12.0-J18.9 and U07.1)`) %>% filter(Indicator == "Week-ending")

knitr::kable(provisional_death_counts)
```
 <!-- This code is for pneumonia and covid deaths --> 
